...
exports.mikroV17WorkDataAktar = function (orgDoc, storeDoc, fisData) {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      let cariKod = ''
      if ((fisData.customers || []).length > 0) {
        // TODO : buraya cari gelecek
      }
      ...
      let query = `
        ...
        DECLARE @STH_CARI_KODU VARCHAR(50) = '${cariKod}';
      ...
      fisData.sales.forEach((e, rowIndex) => {
        if (e.status) {
          ...
          sth_MainProgramNo, sth_VersionNo, sth_MenuNo, sth_MikroSpecial1, sth_MikroSpecial2, sth_MikroSpecial3, sth_ExternalProgramType, sth_ExternalProgramId, sth_Hash,
          ...
          1 /*sth_MainProgramNo*/, @MikroVersionNo /*sth_VersionNo*/, '100056' /*sth_MenuNo*/, '' /*sth_MikroSpecial1*/, '' /*sth_MikroSpecial2*/, '' /*sth_MikroSpecial3*/, 
      ...
      query += `SET @SatirNo=@SatirNo+1;\n`
      query += odemeV17Insert(fisData, tarih, depoNo, odemeToplam, odemeToplam)
...
function odemeV17Insert(fisData, tarih, depoNo, amount, odemeToplam) {
  let q = `SET @OdemeOran=${amount}/${odemeToplam};
          ...
          VALUES(NEWID(), 0, 0, 0, 1003, 0, 0, 0, 0, @MikroUserNo, GETDATE(), @MikroUserNo, GETDATE(), '', '', '', 
            1 /*po_MainProgramNo*/, @MikroVersionNo /*po_VersionNo*/, '100056' /*po_MenuNo*/, '' /*po_MikroSpecial1*/, '' /*po_MikroSpecial2*/, '' /*po_MikroSpecial3*/,
