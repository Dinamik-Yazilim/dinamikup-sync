        ...
        DECLARE @Tarih DATETIME='2025-06-01'
        DECLARE @EvrakSira INT=130094;
        DECLARE @EvrakSeri VARCHAR(50)='K005';
        ...
        IF NOT EXISTS(SELECT * FROM S_20250601_1001 WHERE integrationCode='546b162d-a298-4417-91ef-49f8b282c5cb') BEGIN
          ...
          @EvrakSeri, @EvrakSira, @SatirNo, '13' /*sth_belge_no*/, @Tarih /*sth_belge_tarih*/,
          '29003838' /*sth_stok_kod*/, 0 /*sth_isk_mas1*/, 0 /*sth_isk_mas2*/, 0 /*sth_isk_mas3*/, 0 /*sth_isk_mas4*/, 0 /*sth_isk_mas5*/, 0 /*sth_isk_mas6*/,
          ...
          31.818181818181817 /*sth_tutar*/, 0 /*sth_iskonto1*/, 0 /*sth_iskonto2*/, 0 /*sth_iskonto3*/, 0 /*sth_iskonto4*/, 0 /*sth_iskonto5*/, 0 /*sth_iskonto6*/, 
          0 /*sth_masraf1*/, 0 /*sth_masraf2*/, 0 /*sth_masraf3*/, 0 /*sth_masraf4*/, @VergiPntr /*sth_vergi_pntr*/, 
          3.1818181818181834 /*sth_vergi*/, 0 /*sth_masraf_vergi_pntr*/, 0 /*sth_masraf_vergi*/, 0 /*sth_netagirlik*/, 0 /*sth_odeme_op*/,
          '2803041' /*sth_aciklama*/, '00000000-0000-0000-0000-000000000000' /*sth_sip_uid*/, '00000000-0000-0000-0000-000000000000' /*sth_fat_uid*/, 
        ...
        SET @SatirNo=-1;SET @SatirNo=@SatirNo+1;
          ...
          VALUES(NEWID(), 0, 0, 0, 1003, 0, 0, 0, 0, @MikroUserNo, GETDATE(), @MikroUserNo, GETDATE(), '', '', '', 0, 0, 
            @EvrakSeri /*po_KasaKodu*/, @EvrakSira /*po_BelgeNo*/, 13 /*po_MyeZNo*/, '' /*po_KasiyerKodu*/, 
            '2025-06-01T21:58:37' /*po_BelgeTarihi*/, 35 /*po_BelgeToplam*/, @VergiMatrah0*@OdemeOran /*po_VerMtrh0*/, 
            ...
            '' /*po_CariKodu*/, 0 /*po_Yuvarlama*/, 35 /*po_Odm_AnaDtut1*/, 35 /*po_Odm_OrjDtut1*/, 0 /*po_Odm_AnaDtut2*/, 0 /*po_Odm_OrjDtut2*/, 0 /*po_Odm_AnaDtut3*/, 0 /*po_Odm_OrjDtut3*/, 0 /*po_Odm_AnaDtut4*/, 
            ...
            '' /*po_YolcuBeraberAraciKurumKodu*/, 0 /*po_GibeGonderildiFl*/, '546b162d-a298-4417-91ef-49f8b282c5cb' /*integrationCode*/);
          END;